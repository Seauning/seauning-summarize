...
key:"bindEvent",
value:function(){
var e,t=this,n=(e={},_defineProperty(e,P,function(e){
var n=e.cmtData;
...
return a(e);
}),_defineProperty(i,x,function(e){
return a(e);
}),i));
}():v&&!function(){
...
}),t.showActionSheet(e,a,r),o.classList.remove(A),i.preventDefault(),p=!0;
};
...
return _(e);
}),_defineProperty(o,x,function(e){
return _(e);
}),o));
var f=function(e){
var t=e.el;
...
return f(e);
}),_defineProperty(a,x,function(e){
return f(e);
}),a));
var g=function(e){
var t=e.el;
...
return g(e);
}),_defineProperty(s,x,function(e){
return g(e);
}),s)),r.on(document,"contextmenu",function(e){
y&&l.isParent(e.target,y)&&(e.preventDefault(),tt());
...
key:"add",
value:function(e){
var t=this,n=e.data,i=e.mode,o=void 0===i?"push":i,a=e.type,r=void 0===a?"comment":a,s=e.cmtData,c=e.contentId,m=e.myId,p=e.pos,d=void 0,u=void 0,y=void 0,_=void 0,f=void 0;
"comment"===r?(d="getCommentListHTML",u="content_id",y=this,_="data",f=this.container):(d="getReplyListHTML",
u="reply_id","reply"!==this.type?(s||(s=this.getData(void 0!==c?{
contentId:c
}:{
myId:m
})),s&&(y=s.reply_new,_="reply_list",f=l.qs(".js_reply_list",this.getComment(s.content_id).parentNode))):(s||(s=this.cmtData),
...
if(i>0&&i<e.length){
if(e[i][u]!==n[0][u]){
var l=t.getItemFrag(d,n,s),c=l.frag,m=l.itemList,g="comment"===r?t.getCommentIdx(p):t.getReplyIdx(s.content_id,p);
...
var v=t.getItemFrag(d,n,s),c=v.frag,m=v.itemList,g="comment"===r?t.getCommentIdx(p):t.getReplyIdx(s.content_id,p);
...
"number"!=typeof p&&(p=u[_]+(m?1:-1)),u[_]=p,e.changeLikeStatus("comment"===i?l.qs("."+P,this.getComment(o.content_id)):l.qs("."+M,this.getReply(o.content_id,a.reply_id)),m,p),
...
value:function(t,n){
var i,o=this;
n=_extends((i={},_defineProperty(i,P,null),_defineProperty(i,M,null),_defineProperty(i,E,null),
_defineProperty(i,H,null),_defineProperty(i,N,null),_defineProperty(i,z,null),_defineProperty(i,x,null),
i),n);
var a=Object.keys(n);
...
for(var s=null,c=null,m=null,p=null,d=i,u=d.classList;d&&!u.contains(T)&&!u.contains(x);)d=d.parentNode,
u=d.classList;
...
e=l.trim(e),b&&(e=e.replace(/<br\/>/g,"").replace(/\n/g,"")||"");
