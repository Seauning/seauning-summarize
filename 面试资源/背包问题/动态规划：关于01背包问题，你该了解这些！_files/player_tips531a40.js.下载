...
var n=t("pages/mod/bottom_modal.html.js"),s=t("biz_common/tmpl.js"),i=t("biz_common/dom/class.js"),l=t("biz_common/dom/event.js"),a=t("biz_wap/utils/device.js"),r=t("common/navShadow.js"),c=100,h="weui-btn_disabled",p={
...
_classCallCheck(this,t),o=_extends({},p,o);
...
},50),a.os.ios?o.focus():(this.tmpInputEle||(this.tmpInputEle=o.cloneNode(!0)),this.tmpInputEle.style.opacity=0,
...
},300),this.tmpInputEle.focus()),a.os.ios&&!this.hasBindInputEvent&&this.opt.makeFakeInputEle&&this.opt.removeInputEle&&(this.hasBindInputEvent=!0,
l.on(o,"focus",function(){
setTimeout(function(){
o.style.opacity=1,n.opt.removeInputEle();
},50);
}),l.on(o,"blur",function(){
