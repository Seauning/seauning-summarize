...
});define("a/mpAdAsync.js",["appmsg/log.js","biz_wap/utils/ajax.js","rt/appmsg/getappmsgext.rt.js","a/a.js","a/a_utils.js","biz_common/utils/url/parse.js","a/a_config.js","pages/version4video.js","common/utils.js","biz_common/utils/wxgspeedsdk.js"],function(e){
"use strict";
function i(e,i){
var s=document.getElementsByTagName("iframe");
if(window.originalVideoAdFramesAdData=window.originalVideoAdFramesAdData||{},window.originalVideoAdFramesUnsetList)for(var t=0;t<window.originalVideoAdFramesUnsetList.length;t++)for(var a=0;a<s.length;a++)if(s[a].dataset&&s[a].dataset.mpvid===window.originalVideoAdFramesUnsetList[t]){
window.originalVideoAdFramesAdData[s[a].dataset.mpvid]||(window.originalVideoAdFramesAdData[s[a].dataset.mpvid]={}),
i=window.originalVideoAdFramesAdData[s[a].dataset.mpvid],s[a].contentWindow.postMessage({
...
m.broadcastFrame(i,p.APPMSGAD_READY_ACTION,e),m.listenMessage(window,function(i,s){
s.action===p.GET_APPMSGAD_READY_STATUS_ACTION&&m.postMessage(i.source,p.APPMSGAD_READY_ACTION,e);
});
}
function t(e){
...
function a(e){
var a=arguments.length<=1||void 0===arguments[1]?{}:arguments[1],l=arguments[2],u=[],v=r.checkNeedAds();
v.is_need_ad=a.forceGetAd?1:v.is_need_ad;
var f=window.isPaySubscribe?0:v.is_need_ad,y=window.isPaySubscribe?1:0,A=c.getQuery("mock"),D=c.getQuery("rtx"),j="/mockserver/mockservercgi-bin/offerTestCase/mmbizwap/mp/getappmsgad",b="/mp/getappmsgad",h="5"===window.item_show_type,k=h&&!_.isNativePage()&&!c.getQuery("get_ad_after_video"),x=w.isUseAd()&&!k,V=window.pos_type_list?JSON.stringify(window.pos_type_list.split("|").map(function(e){
return Number(e);
})):"",F=Date.now(),N="string"==typeof a.version?a.devicetype:window.clientversion.htmlDecode();
window.__second_open__&&(N=window.clientversion.htmlDecode()),e=e||[];
for(var O=0;O<e.length;O++)0===e[O].indexOf(p.ORIGIN_VIDEO_VID_PREFIX)&&u.push(e[O]);
(A&&"-1"!==A||D)&&(console.info("[广告走mock系统] mockId",A,"rtx",D),b=j),console.info("[广告发送请求] 是否拉取广告",f),
console.info("[强制广告] 是否强制去掉广告",y),y?t(u):n({
url:b+"?f=json&mockid="+A+"&rtx="+D,
data:{
r:Math.random(),
...
var t=e;
if(t.advertisement_info&&0!==t.advertisement_info.length)try{
if(o("[Appmsg] success get async ad data, async data is: "+JSON.stringify(t)),window.originalVideoAdFramesAdData={},
t.advertisement_info)for(var a=0;a<t.advertisement_info.length;a++){
t.advertisement_info[a].cdg_appid=t.appid;
var n=t.advertisement_info[a].vid;
n&&"string"==typeof n&&1===t.advertisement_info[a].is_mp_video&&(window.originalVideoAdFramesAdData[n]=m.saveCopy(t.advertisement_info[a]),
_.report120081("0"));
}
...
l&&l(),s(e),Math.random()<.005&&(g.saveSpeeds({
uin:window.user_uin,
pid:2587,
speeds:[{
sid:21,
...
var o=e("appmsg/log.js"),n=e("biz_wap/utils/ajax.js"),d=e("rt/appmsg/getappmsgext.rt.js"),r=e("a/a.js"),m=e("a/a_utils.js"),c=e("biz_common/utils/url/parse.js"),p=e("a/a_config.js"),w=e("pages/version4video.js"),_=e("common/utils.js"),g=e("biz_common/utils/wxgspeedsdk.js");
return{
getAdData:a
};
