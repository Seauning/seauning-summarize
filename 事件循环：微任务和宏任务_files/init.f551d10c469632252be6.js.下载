...
function c(e, t, n) {
let i = "dark" == n ? o : a, c = e.getSVGDocument();
if (!c) return;
let s = [ "fill", "stroke" ];
for (let e of s) for (let t of c.querySelectorAll("[".concat(e, "]"))) {
let n = r(t.getAttribute(e));
if ("none" == n) continue;
let o = i[n];
o && t.setAttribute(e, o);
}
for (let e of c.querySelectorAll("[style]")) for (let t of s) if (e.style[t]) {
let n = r(e.style[t]);
if ("none" == n) continue;
let o = i[n];
o && (e.style[t] = i[o]);
...
"OBJECT" == e.tagName && "image/svg+xml" == e.type && e.hasAttribute("data-use-theme") && "dark" == document.documentElement.dataset.theme && c(e, "light", "dark");
}), !0)), window.themeSvg = c;
}, function(e, t) {
e.exports = {
"#c9dcea": "#293c40",
...
let n = new o;
n.setContent('<div class="gdpr">\n    <h1 class="gdpr__title">'.concat("本网站使用 cookie", '</h1>\n    <form class="gdpr__form">\n      <p class="gdpr__text">').concat('我们使用 cookie 和本地存储等浏览器技术来存储你的偏好设置。你需要接受我们的 <a href="/privacy">隐私政策</a> 和本网站的 <a href="/terms">其他条款</a>。', '</p>\n      \n      <input class="button button_action" autofocus name="accept" type="submit" value="').concat("接受", '">\n      <input class="button button_cancel" name="cancel" type="button" value="').concat("取消", '">\n      \n    </form>\n    </div>\n  ')), 
...
//# sourceMappingURL=init.f551d10c469632252be6.js.map